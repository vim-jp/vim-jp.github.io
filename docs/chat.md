...
※ Slackの仕様上、極端に人数が少ないチャンネル(~30人程度)や、他のユーザーによって招待された場合は入退室ログが表示されます。
...
<a href="https://join.slack.com/t/vim-jp/shared_invite/zt-3zhiduqna-w190bsrHJoFthhEIKw_~TQ"><button class="download_button">行動規範に同意して招待ページへ移動する</button></a>
...
また、一定期間経過した会話ログは将来公開され、誰でも閲覧可能になる予定です。
